...
// FAQ Section Headers
    ...
    "post1p2": "Так захоплююче! Так по-новітньому! Таке приголомшливе!",
    ...
    "credits-inspiration-journal": "натхнення із системи журналу, квестів, маршруту геноциду, легкого/складного режиму",
    "credits-inspiration-double": "натхнення для ідеї подвійних падших людей, деякі елементи з ігрової механіки",
    ...
    "credits-inspiration-sprites": "натхнення для створення спрайтів, особливо руїн",
    ...
    "faq-free-answer": "Так, UTTOR повністю безкоштовна як фанатський проєкт. Проте, пожертви на підтримку розробки вітаються!",
    ...
    "faq-save-answer": "Windows: Відкрийте Провідник, введіть %localappdata% в рядок навігації та знайдіть папку UTTOR. Mac: Відкрийте Finder, натисніть Go > Go to Folder... і введіть ~/Library/Application Support/UTTOR.",
},
